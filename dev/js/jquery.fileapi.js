...
(function ($, api){
	...
	var Plugin = function (el, options){
		...
		this.options  = { // current options
			...
			elements: {
				ctrl: {
					...
					reload: _optDataAttr('ctrl.reload'),
		...
		this.$el
			...
			.on('reload.fileapi', _bind(this, this._onReload))
		...
		if( ctrl ){
			...
			this._listen('click', ctrl.reload, _bind(this, this._onReload));
	...
	Plugin.prototype = {
		...
		_redraw: function (clearFiles/**Boolean*/, clearPreview/**Boolean*/){
			...
			// Reload control
			this._disableElem('ctrl.reload', emptyQueue || active);
